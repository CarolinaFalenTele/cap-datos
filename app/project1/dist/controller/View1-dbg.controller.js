sap.ui.define([
  ...
  function (Controller, VizFrame, MessageToast, ODataModel, Sorter, Filter, FilterOperator, JSONModel, FilterType,) {
    ...
    return Controller.extend("project1.controller.View1", {
          ...
          if (response.ok) {
            ...
            if (generatedId) {
              ...
              await Promise.all([
                ...
                this.insertarProveedor(generatedId, sCsrfToken),
                this.insertFacturacion(generatedId, sCsrfToken),
                this.insertClientFactura(generatedId, sCsrfToken),
                this.insertRecursosInternos(generatedId, sCsrfToken),
      ...
      insertRecursosInternos: async function (generatedId, sCsrfToken) {
        ...
        for (let i = 0; i < aItems.length; i++) {
          ...
          if (response.ok) {
            ...
            await this.insertOtrosGastos(idRecursos, sCsrfToken);
